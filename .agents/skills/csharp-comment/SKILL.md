...
- Follow the repository language preference when the surrounding codebase already establishes one. Otherwise prefer Traditional Chinese for prose comments in this repository.
